...
def upgrade() -> None:
    ...
    sa.CheckConstraint("league_type IN ('classic','h2h')", name=op.f('ck_leagues_league_type_enum')),
    ...
    op.create_index('ix_raw_snapshots_source_fetched_at', 'raw_snapshots', ['source', 'fetched_at'], unique=False)
    ...
    sa.CheckConstraint("age_band IN ('under13','13_15','16_17','adult','unknown')", name=op.f('ck_users_age_band_enum')),
    ...
    op.create_table('projection_accuracy',
    ...
    sa.CheckConstraint('position BETWEEN 1 AND 5', name=op.f('ck_players_player_position_range')),
    ...
    sa.ForeignKeyConstraint(['entry_id'], ['managers.entry_id'], name=op.f('fk_league_members_entry_id_managers')),
    ...
    sa.ForeignKeyConstraint(['league_id'], ['leagues.id'], name=op.f('fk_user_leagues_league_id_leagues'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_user_leagues_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('user_id', 'league_id', name=op.f('pk_user_leagues'))
    )
    op.create_table('manager_picks',
    sa.Column('entry_id', sa.Integer(), nullable=False),
    sa.Column('gameweek_id', sa.SmallInteger(), nullable=False),
    sa.Column('picks', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=False),
    ...
    sa.Column('fetched_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['entry_id'], ['managers.entry_id'], name=op.f('fk_manager_picks_entry_id_managers')),
    sa.ForeignKeyConstraint(['gameweek_id'], ['gameweeks.id'], name=op.f('fk_manager_picks_gameweek_id_gameweeks')),
    ...
    sa.ForeignKeyConstraint(['entry_id'], ['managers.entry_id'], name=op.f('fk_manager_transfers_entry_id_managers')),
    sa.ForeignKeyConstraint(['gameweek_id'], ['gameweeks.id'], name=op.f('fk_manager_transfers_gameweek_id_gameweeks')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_manager_transfers')),
    sa.UniqueConstraint('entry_id', 'gameweek_id', 'element_in', 'element_out', name='uq_manager_transfers_natural')
    )
    op.create_index('ix_manager_transfers_entry_id', 'manager_transfers', ['entry_id'], unique=False)
    op.create_table('manager_history',
    sa.Column('entry_id', sa.Integer(), nullable=False),
    sa.Column('gameweek_id', sa.SmallInteger(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['entry_id'], ['managers.entry_id'], name=op.f('fk_manager_history_entry_id_managers')),
    sa.ForeignKeyConstraint(['gameweek_id'], ['gameweeks.id'], name=op.f('fk_manager_history_gameweek_id_gameweeks')),
    sa.PrimaryKeyConstraint('entry_id', 'gameweek_id', name=op.f('pk_manager_history'))
    )
    op.create_table('manager_chips',
    sa.Column('entry_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=24), nullable=False),
    sa.Column('gameweek_id', sa.SmallInteger(), nullable=False),
    sa.Column('played_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['entry_id'], ['managers.entry_id'], name=op.f('fk_manager_chips_entry_id_managers')),
    sa.PrimaryKeyConstraint('entry_id', 'name', 'gameweek_id', name=op.f('pk_manager_chips'))
    )
    op.create_table('auth_tokens',
    sa.Column('token_hash', sa.LargeBinary().with_variant(postgresql.BYTEA(), 'postgresql'), nullable=False),
    sa.Column('user_id', overtake.db.types.GUID(), nullable=False),
    sa.Column('purpose', sa.Text(), nullable=False),
    sa.Column('expires_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('consumed_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('created_ip', sa.String(length=45).with_variant(postgresql.INET(), 'postgresql'), nullable=True),
    sa.CheckConstraint("purpose IN ('login','email_change')", name=op.f('ck_auth_tokens_auth_token_purpose')),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("plan IN ('monthly','season')", name=op.f('ck_subscriptions_subscription_plan')),
    ...
    sa.Column('props', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index('ix_analytics_events_name_created_at', 'analytics_events', ['name', 'created_at'], unique=False)
    ...
    sa.Column('computed_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['league_id'], ['leagues.id'], name=op.f('fk_simulations_league_id_leagues'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_simulations')),
    sa.UniqueConstraint('league_id', 'gameweek_id', 'input_hash', name='uq_simulations_cache_key')
    )
    op.create_index('ix_simulations_league_gw', 'simulations', ['league_id', 'gameweek_id'], unique=False)
    op.create_table('rival_profiles',
    sa.Column('entry_id', sa.Integer(), nullable=False),
    sa.Column('season', sa.Text(), nullable=False),
    ...
    sa.Column('chips_used', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=False),
    sa.Column('computed_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['entry_id'], ['managers.entry_id'], name=op.f('fk_rival_profiles_entry_id_managers')),
    ...
    sa.Column('payload', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['league_id'], ['leagues.id'], name=op.f('fk_league_memory_league_id_leagues'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_league_memory')),
    sa.UniqueConstraint('league_id', 'gameweek_id', 'kind', 'entry_id', name='uq_league_memory_event')
    )
    op.create_index('ix_league_memory_league_gw', 'league_memory', ['league_id', 'gameweek_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('expires_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['league_id'], ['leagues.id'], name=op.f('fk_conversations_league_id_leagues'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_conversations_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_conversations'))
    )
    op.create_index('ix_conversations_user_league', 'conversations', ['user_id', 'league_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['gameweek_id'], ['gameweeks.id'], name=op.f('fk_player_gameweek_stats_gameweek_id_gameweeks')),
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], name=op.f('fk_player_gameweek_stats_player_id_players')),
    ...
    sa.Column('computed_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['gameweek_id'], ['gameweeks.id'], name=op.f('fk_projections_gameweek_id_gameweeks')),
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], name=op.f('fk_projections_player_id_players')),
    sa.PrimaryKeyConstraint('player_id', 'gameweek_id', 'model_version', name=op.f('pk_projections'))
    )
    ...
    sa.Column('cost_usd', sa.Numeric(precision=8, scale=5), nullable=False),
    sa.Column('validation', sa.JSON().with_variant(postgresql.JSONB(astext_type=sa.Text()), 'postgresql'), nullable=False),
    sa.Column('emailed_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['league_id'], ['leagues.id'], name=op.f('fk_briefs_league_id_leagues'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['simulation_id'], ['simulations.id'], name=op.f('fk_briefs_simulation_id_simulations'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_briefs_user_id_users'), ondelete='CASCADE'),
